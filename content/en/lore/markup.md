...
A regular paragraph with **bold**, *italic*, `code` and a [link to another article](history.md). An external source looks like this: [mod website](https://example.org). And this is a link to an article that is not written yet: [Black Market Territory](black-market.md).
...
> Quotes fit character lines and excerpts from documents. **Emphasis** and [links](proton.md) work inside them too.
