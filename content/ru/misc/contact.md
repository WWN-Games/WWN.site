...
- **GitLab** — [репозиторий мода](https://gitlab.com/wwn.games/wwn.mod-rustedwarfare/WWN-Mod): релизы, баги и вклад.
...
4. Создайте обращение на странице [Issues](https://gitlab.com/wwn.games/wwn.mod-rustedwarfare/WWN-Mod/-/issues).
